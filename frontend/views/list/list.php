...
<div class="breadcrumb">
    <h2>当前位置：<?=\yii\helpers\Html::a('首页',['frontend/frontend1'])?> > <a href="">电脑、办公</a></h2>
</div>
...
<div class="list_left fl mt10">
        <div class="catlist">
            ...
            <div class="catlist_wrap">
                <?php foreach($model->children as $k=>$cates):?>
                <div class="child">
                    <h3 class="on"><b><?=$cates->name?></b></h3>
                    <ul class="<?= $k == 0 ? 'on' : '' ;?>">
                        <?php foreach($cates->children as $cate):?>

                        <li><?=\yii\helpers\Html::a(['goods/goods','id'=>$cate->id])?><?=$cate->name?></a></li>
                        <?php endforeach;?>
...
<div class="list_bd fl ml10 mt10">
    ...
    <div class="goodslist mt10">
        <ul>
            ...
            <li>
                <dl>
                    <dt><a href=""><img src="<?=$good->logo?>"></dt>
