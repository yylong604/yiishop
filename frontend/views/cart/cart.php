...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tfoot>
        <tr>
            <td colspan="6">购物金额总计： <strong>￥ <span id="total"><?=$good['num']*$good['shop_price']?></span></strong></td>
        </tr>
        </tfoot>
    </table>
    <div class="cart_btn w990 bc mt10">
        <a href="" class="continue">继续购物</a>
        <a href="<?=\yii\helpers\Url::to(['order/order'])?>" type="submit" class="checkout">结 算</a>
    </div>
</div>
<!-- 主体部分 end -->
<?php
