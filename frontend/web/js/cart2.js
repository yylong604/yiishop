...
function total(){
	var goods = $('#goods_total_parice').text();

	var delivery_price = 0;
	//$("#deliver_price").text(100);
	delivery_price += $("#delivery_price").text();
	var total = parseInt(goods) + parseInt(delivery_price);
...
$(".delivery_name").click(function(){
	...
	var b = td.next();
	var delivery_price = parseInt(b.text());
	$("#delivery_price").text(delivery_price);
	$(".total_pay").text(delivery_price);
